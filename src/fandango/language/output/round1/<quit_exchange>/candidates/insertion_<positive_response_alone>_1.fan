...
<quit_exchange> ::= <banner_exchange> <Client:QUIT> <Server:quit_response> | <mutation_quit_exchange>
...
<mutation_quit_exchange> ::= <banner_exchange> <positive_response_alone> <Client:QUIT> <Server:quit_response>
