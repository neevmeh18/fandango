...
<uidl_response> ::= <positive_response> <termination> | <negative_response> |  <bare_positive_response> <uidl_listing> #$$$$$$wrong nonterminal replace termination with uidl listing
