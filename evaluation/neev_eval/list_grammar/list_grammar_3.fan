...
# ---- SERVER RESPONSES ----
<user_response> ::= <positive_response> | <negative_response>#$$$$$$$$$$$$$missing positive response alone 
<pass_response> ::= <positive_response> | <negative_response>
<list_response> ::= <positive_response_multiline> | <negative_response> | <positive_response> | <positive_response_alone>
